      ...
      return [
        {
          source: '/api/recipes',
          headers: [
            { key: 'Access-Control-Allow-Origin', value: 'https://fit-kitchen-frontend-tst.vercel.app, https://ii3160-production.up.railway.app, https://spotify-bot.azurewebsites.net, https://localhost:3000' },
